...
pet_type_enum = sa.Enum("dog", "cat", "bird", "fish", name="pet_type_enum")
payment_method_enum = sa.Enum("cod", "bank_transfer", name="payment_method_enum")
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("country", sa.String(length=100), server_default=sa.text("'Vietnam'"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("shipping_country", sa.String(length=100), server_default=sa.text("'Vietnam'"), nullable=False),
        sa.Column("customer_note", sa.Text(), nullable=True),
        sa.Column("subtotal", sa.Numeric(precision=12, scale=2), nullable=False),
        sa.Column("shipping_fee", sa.Numeric(precision=12, scale=2), server_default=sa.text("0"), nullable=False),

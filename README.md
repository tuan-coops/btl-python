...
- Đăng nhập admin: `frontend/pages/admin-login.html`
- Dashboard: `frontend/pages/admin-dashboard.html`
- Quản lý danh mục: `frontend/pages/admin-categories.html`
- Quản lý sản phẩm: `frontend/pages/admin-products.html`
- Quản lý đơn hàng: `frontend/pages/admin-orders.html`
- Quản lý khách hàng: `frontend/pages/admin-customers.html`
- Quản lý bài viết: `frontend/pages/admin-articles.html`
